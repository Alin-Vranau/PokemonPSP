...
//		JSONArray 
	...
	public screenPokedex() {
		...
		pnTable.setBounds(493, 65, 154, 352);
...
//		JTable pokeTable = new JTable (listaPokemons, nombresColumnas);
		...
		try {
			bulbasaur = new ImageIcon(new URL("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/showdown/1.gif"));
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    try {
                        ...
                        BufferedReader inSpecies = new BufferedReader(new InputStreamReader(conSpecies.getInputStream()));
                        ...
                        String frontDefaultGif = jsonResponse.getJSONObject("sprites").getJSONObject("other").getJSONObject("showdown").getString("front_default");
                        String frontDefaultPng = jsonResponse.getJSONObject("sprites").getJSONObject("versions").getJSONObject("generation-vi").getJSONObject("x-y").getString("front_default");
                        ...
                        String tipo1 = jsonResponse.getJSONArray("types").getJSONObject(0).getJSONObject("type").getString("name").toUpperCase();
                        String tipo2 = null;
                        try {
                            tipo2 = jsonResponse.getJSONArray("types").getJSONObject(1).getJSONObject("type").getString("name").toUpperCase();
						} catch (Exception e2) {
							tipo2 = "";
						}
                        ...
                        String descrption = jsonResponseSpecies.getJSONArray("flavor_text_entries").getJSONObject(26).getString("flavor_text");
                        textDescription.setText(descrption);
                        //Habitat
                        textHabitat.setText(jsonResponseSpecies.getJSONObject("habitat").getString("name").toUpperCase());
	...
	public Color colorTipo(String tipo) {
		...
		switch (tipo) {
		case "WATER": color = new Color(104, 144, 240);		
			break;
		case "FIGHTING": color = new Color(232, 48, 0);
			break;
		case "FLYING": color = new Color(152, 216, 216);
			break;
		case "POISON": color = new Color(160, 64, 160);
			break;
		case "GROUND": color = new Color(153, 77, 0);
			break;
		case "ROCK": color = new Color(184, 160, 56);
			break;
		case "BUG": color = new Color(120, 200, 80);
			break;
		case "GHOST": color = new Color(83, 33, 83);
			break;
		case "STEEL": color = new Color(102, 153, 174);
			break;
		case "FIRE": color = new Color(240, 128, 48);
			break;
		case "GRASS": color = new Color(0, 193, 93);
			break;
		case "ELECTRIC": color = new Color(248, 176, 16);
			break;
		case "PSYCHIC": color = new Color(248, 88, 136);
			break;
		case "ICE": color = new Color(178, 254, 254);
			break;
		case "DRAGON": color = new Color(70, 98, 163);
			break;
		case "DARK": color = new Color(35, 52, 59);
			break;
		case "FAIRY": color = new Color(113, 140, 206);
			break;
		case "UNKNOWN": color = new Color(113, 140, 206);
			break;
		case "SHADOW": color = new Color(113, 140, 206);
			break;
		case "NORMAL": color = new Color(168, 168, 120);
			break;
		}
		return color;
	}
